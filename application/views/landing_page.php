               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>aplikasi ini dibuat untuk membantu Penggajian Karyawan di pondok pesantren Tasywiqul Furqon</p>
                     </div>
                  </div>
                  <div class="col headerImg" style="background-image: url('<?php echo base_url()?>assets/img/20220208_105539.jpg');"></div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi singkat tentang website penggajian karyawan di pondok pesantren Tasywiqul Furqon
               </div>
            </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel1">aplikasi ini dibuat untuk membantu CV dalam proses penggajian karyawan</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel3">Halaman karyawan terdapat informasi tentang penggajian dan cetak slip gaji.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel4">Cetak slip gaji, lupa password, login </div>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/201951002.jpg" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">Shaffa Wahyu Fadholi</div>
